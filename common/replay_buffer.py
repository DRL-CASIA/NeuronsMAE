...
class ReplayBuffer:
    ...
    def __init__(self, args):
        ...
        self.buffers = {'o':             np.empty([self.size,  1 * self.n_agents_per_party, self.obs_shape]),
                        'u':             np.empty([self.size,  1 * self.n_agents_per_party,  1]),
                        's':             np.empty([self.size,  self.state_shape]),
                        'r':             np.empty([self.size,  1]),
                        'o_next':        np.empty([self.size,  1 * self.n_agents_per_party, self.obs_shape]),
                        's_next':        np.empty([self.size,  self.state_shape]),
                        'avail_u':       np.empty([self.size,  1 * self.n_agents_per_party, self.n_actions]),
                        'avail_u_next':  np.empty([self.size,  1 * self.n_agents_per_party, self.n_actions]),
                        'u_onehot':      np.empty([self.size,  1 * self.n_agents_per_party, self.n_actions]),
